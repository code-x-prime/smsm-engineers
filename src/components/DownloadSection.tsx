...
const brochureDownloads: DownloadItem[] = [
  {
    title: "How To Develop Tinting System",
    category: "Technical Guide & System Setup",
    size: "921 KB",
    format: "PDF",
    description: "Comprehensive industrial roadmap on architecting, deploying, and calibrating retail & industrial paint tinting systems.",
    href: "/downloads/how_to_develop_tinting_system.pdf",
  },
  {
    title: "SMSM Technical Bulletin Sep' 2026",
    category: "Engineering Whitepaper",
    size: "1.05 MB",
    format: "PDF",
    description: "Official technical bulletin detailing latest dispenser precision standards, stepper calibration, and fluid pumping diagnostics.",
    href: "/downloads/smsm_technical_bulletin_sep_2026.pdf",
  },
  {
