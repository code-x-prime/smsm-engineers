    ...
    <div className="w-full flex flex-col relative z-20">
      ...
      <section className="bg-gradient-to-r from-[#0A4ABF] to-[#071A35] text-white py-16 px-6 relative overflow-hidden border-b border-white/5">
        ...
        <div className="relative max-w-[1400px] mx-auto flex flex-col md:flex-row md:items-center md:justify-between gap-8 z-10">
          ...
          <Link
            href="/query-form"
            className="inline-flex items-center gap-2 bg-[#00AEEF] text-[#071A35] font-extrabold text-xs uppercase tracking-wider px-8 py-4 rounded-sm hover:bg-white hover:text-[#071A35] transition-all shrink-0 hover:shadow-[0_0_15px_rgba(0,174,239,0.4)]"
          >
        ...
        <div className="relative max-w-[1400px] mx-auto px-6 py-20 z-10">
          <div className="grid lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-4 space-y-6">
              ...
              <div className="flex items-center gap-4 pt-2">
                <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="h-9 w-9 rounded-sm border border-slate-200 flex items-center justify-center hover:bg-[#0A4ABF] hover:text-white hover:border-transparent transition-all text-slate-600">
                  <IconBrandLinkedin className="h-4 w-4" />
                </a>
                <a href="https://wa.me/918130720777" target="_blank" rel="noopener noreferrer" className="h-9 w-9 rounded-sm border border-slate-200 flex items-center justify-center hover:bg-[#0A4ABF] hover:text-white hover:border-transparent transition-all text-slate-600">
            ...
            {/* Columns 2-5 Grid */}
            <div className="lg:col-span-8 grid sm:grid-cols-4 gap-10">
              {/* Column 2: Quick Links */}
              <div>
                <div className="text-xs uppercase tracking-wider text-[#0A4ABF] font-bold mb-5 border-b border-slate-200 pb-2">Company</div>
              ...
              {/* Column 3: Products */}
              <div>
                <div className="text-xs uppercase tracking-wider text-[#0A4ABF] font-bold mb-5 border-b border-slate-200 pb-2">Products</div>
              ...
              {/* Column 4: Services */}
              <div>
                <div className="text-xs uppercase tracking-wider text-[#0A4ABF] font-bold mb-5 border-b border-slate-200 pb-2">Services</div>
                <ul className="space-y-3 text-sm text-slate-600 font-light">
              ...
              <div>
                <div className="text-xs uppercase tracking-wider text-[#0A4ABF] font-bold mb-5 border-b border-slate-200 pb-2">Reach Us</div>
          ...
          <div className="mt-16 pt-8 border-t border-slate-200 flex flex-col md:flex-row md:items-center justify-between gap-4 text-xs text-slate-400">
            ...
            <div className="flex gap-6">
              <span>ISO-Aligned Quality Systems</span>
